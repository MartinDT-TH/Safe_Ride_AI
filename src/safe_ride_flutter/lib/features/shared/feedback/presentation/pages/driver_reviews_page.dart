...
class DriverReviewsPage extends StatefulWidget {
  DriverReviewsPage({super.key, required this.driverId, this.driverName});
...
class _DriverReviewsPageState extends State<DriverReviewsPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<FeedbackProvider>().loadDriverRatings(
        token,
        widget.driverId,
      );
    });
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          ...
          child: Container(color: Color(0xFFF0F0F0), height: 1),
        ),
      ),
      body: Consumer<FeedbackProvider>(
        builder: (context, provider, child) {
          ...
          if (summary == null || summary.totalRatings == 0) {
            return Center(
              child: Text(
                context.l10n.driverHasNoReviews,
                style: TextStyle(color: Color(0xFF6B6B6B)),
              ),
            );
          }
...
class _RatingSummaryCard extends StatelessWidget {
  _RatingSummaryCard({required this.summary});
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6),
                Text(
                  '${summary.totalRatings} ${context.l10n.reviews}',
                  style: TextStyle(
                    fontSize: 13,
...
class _ReviewList extends StatelessWidget {
  _ReviewList({required this.ratings});
