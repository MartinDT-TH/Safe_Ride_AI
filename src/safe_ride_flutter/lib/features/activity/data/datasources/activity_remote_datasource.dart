...
import '../models/activity_trip.dart';

class ActivityRemoteDatasource {
  ActivityRemoteDatasource({Dio? dio}) : _dio = dio ?? DioClient().dio;

  final Dio _dio;

  Future<List<ActivityTrip>> getBookingHistory(String accessToken) async {
    ...
    try {
      ...
      return data.map((json) => ActivityTrip.fromJson(Map<String, dynamic>.from(json))).toList();
