...
class DriverProfilePage extends StatelessWidget {
  const DriverProfilePage({
    ...
    this.avatarUrl = 'https://img.freepik.com/free-photo/handsome-young-man-with-new-haircut_176420-19636.jpg',
    this.rating = 4.9,
    this.tripCount = 1200,
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: _ExperienceCard(years: experienceYears),
                ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Icon(Icons.work_history_outlined, color: AppColors.primary, size: 28),
          const Spacer(),
          const Text(
            'KINH NGHIỆM',
            style: TextStyle(
