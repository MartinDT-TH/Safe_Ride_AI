...
class _TripTrackingPageState extends State<TripTrackingPage>
  ...
  void _showShareModal() {
    showDialog(
      context: context,
      builder: (context) => Center(child: ShareTripModal()),
    );
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              context.l10n.shareRouteDescription,
              ...
              child: Row(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Clipboard.setData(
                        ClipboardData(text: 'saferide.vn/track/SR94210'),
                      );
