...
class _SearchingDriverPageState extends State<SearchingDriverPage> {
  ...
  Future<void> _updateMarkerOffset() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _markerScreenOffset = Offset(screenPos.x.toDouble(), screenPos.y.toDouble());
        });
      }
    } catch (e) {
  ...
  bool _shouldShowDriverCard(BookingResponse? booking) {
    ...
    return status != 'Searching' && status != 'PendingSchedule';
  }
}
      ...
      child: Column(
        ...
        children: [
          ...
          if (onDriverPreviewTap != null) ...[
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 24),
              child: _DriverFoundCard(onTap: onDriverPreviewTap!),
            ),
          ],
...
class _DriverFoundCard extends StatelessWidget {
  const _DriverFoundCard({required this.onTap});
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
              ...
              builder: (context, child) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: primaryColor.withOpacity(0.6 * (1.0 - progress)),
                      width: 2,
                    ),
                  ),
                );
          ...
          _buildSimulatedDriver(top: widget.size * 0.2, left: widget.size * 0.25, delay: 0.0),
          _buildSimulatedDriver(top: widget.size * 0.35, right: widget.size * 0.15, delay: 0.4),
          _buildSimulatedDriver(bottom: widget.size * 0.2, left: widget.size * 0.4, delay: 0.8),
        ],
      ),
    );
  }
  ...
  Widget _buildSimulatedDriver({
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        double opacity = val < 0.2 ? val * 5 : (val < 0.8 ? 1.0 : (1.0 - val) * 5);
