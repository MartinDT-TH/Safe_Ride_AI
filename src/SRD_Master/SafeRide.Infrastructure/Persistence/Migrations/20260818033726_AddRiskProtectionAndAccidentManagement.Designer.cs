...
namespace SafeRide.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260818033726_AddRiskProtectionAndAccidentManagement")]
    partial class AddRiskProtectionAndAccidentManagement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SafeRide.Domain.Entities.ProtectionClaim", b =>
                {
                    ...
                    b.ToTable("ProtectionClaims", t =>
                        {
                            t.HasCheckConstraint("CK_ProtectionClaims_Amounts", "[TotalDamageAmount] >= 0 AND [EligibleDamageAmount] >= 0 AND [TotalPaidToClaimant] >= 0 AND [RecoveredAmount] >= 0 AND [OutstandingRecoveryAmount] >= 0");
                        });
                });
