...
namespace SafeRide.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260615044959_AddScheduledBookingAndGoogleRouteEstimate")]
    partial class AddScheduledBookingAndGoogleRouteEstimate
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("DriverKyc", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_DriverKyc_LicenseClass", "[LicenseClass] IS NULL OR [LicenseClass] IN ('A1', 'A', 'B1', 'B', 'C1', 'C', 'D1', 'D2', 'D', 'Old_B1', 'Old_B2', 'Old_A1', 'Old_A2')");
                        });
                });
                    ...
                    b.ToTable("PricingRules", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_PricingRules_VehicleClass", "[VehicleClass] IN ('A1', 'A', 'B', 'C1', 'C', 'D1', 'D2', 'D')");
                        });
                });
                    ...
                    b.ToTable("Vehicles", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Vehicles_RequiredLicenseClass", "[RequiredLicenseClass] IN ('A1', 'A', 'B', 'C1', 'C', 'D1', 'D2', 'D')");
