...
namespace SafeRide.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260620114005_UpdateBookingDriverOfferMatchingStatus")]
    partial class UpdateBookingDriverOfferMatchingStatus
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("BookingDriverOffers", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_BookingDriverOffers_OfferStatus", "[OfferStatus] IN ('Pending', 'Sent', 'Accepted', 'Rejected', 'Expired', 'Cancelled')");
                        });
                });
