...
namespace SafeRide.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260703045530_AddTripReturnConfirmation")]
    partial class AddTripReturnConfirmation
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Trips", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Trips_TripStatus", "[TripStatus] IN ('ACCEPTED', 'DRIVER_ARRIVING', 'ARRIVED', 'IN_PROGRESS', 'WAITING_RETURN_CONFIRM', 'RETURN_CONFIRMED', 'COMPLETED', 'CANCELLED')");
                        });
                });
